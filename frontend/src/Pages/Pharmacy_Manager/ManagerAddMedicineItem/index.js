...
const ManagerAddMedicineItem = () => {
    ...
    const getMedicineTypes = () => {
        //setmedicineTypes
        const url = `${URL}/medicinetypes`
        axios.get(url).then(response => {
            const result = response.data;
            if(result.status === "SUCCESS") {
                setMedicineTypes(result.data)
            } else {
                    ...
                    <div className="form">
                        ...
                        <div className="d-flex justify-content-between">
                            ...
                            <div className="mb-3 float-right">
                               <button className="btn btn-primary" onClick={() => {addMedicineItem()}}>Add Item</button>
                            </div>
                        </div>
...
export default ManagerAddMedicineItem